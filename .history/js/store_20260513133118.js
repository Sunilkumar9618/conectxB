    ...
    const form = `
        ...
        <div class="form-group">
            ...
            <div style="margin-bottom: 10px;">
                <div id="add-product-image-preview" style="width: 100px; height: 100px; border-radius: 8px; background: #333; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-bottom: 10px;">
                    <span style="color: #999; font-size: 12px;">No image</span>
                </div>
            </div>
            <input type="file" accept="image/*" class="form-input" id="add-product-image" placeholder="Upload product image" style="cursor: pointer;">
        </div>
...
function showEditProductModal(productId) {
    ...
    const form = `
        ...
        <div class="form-group">
            <label class="form-label">Product Image</label>
            <div style="margin-bottom: 10px;">
                <div id="edit-product-image-preview" style="width: 100px; height: 100px; border-radius: 8px; background: #333; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-bottom: 10px;">
                    ${product.image ? `<img src="${product.image}" style="width: 100%; height: 100%; object-fit: cover;">` : '<span style="color: #999; font-size: 12px;">No image</span>'}
                </div>
            </div>
            <input type="file" accept="image/*" class="form-input" id="edit-product-image" placeholder="Upload product image" style="cursor: pointer;">
        </div>
...
async function editProductHandler(productId, modal) {
    ...
    // Handle image - either new file or existing base64
    let image = null;
