...
/* ============================================================================
   DASHBOARD - User Dashboard (FIREBASE VERSION)
   ============================================================================ */
...
views.dashboard = async function() {
    ...
    try {
        ...
        // Generate fake analytics (you can replace with real data from Firestore later)
        ...
        const stats = {
            ...
            activeBlocks: 5,
            clickRate: (Math.random() * 10 + 1).toFixed(1)
        };
            ...
            <div class="main-content with-sidebar">
                <div style="padding: var(--spacing-xl);">
                    <div class="dashboard-header">
                        <div>
                            <h1 class="dashboard-greeting">👋 Welcome back, ${user.name || 'Creator'}!</h1>
